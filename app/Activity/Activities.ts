export const activityImages: Record<string, any> = {
 ...
 "BILARD": require("../../assets/images/bilard.png"),
  ...
  "PLAŻÓWKA": require("../../assets/images/siatkowka-plazowa.png"),
  "KOSZYKÓWKA": require("../../assets/images/koszykowka.png"),
  "PIŁKA NOŻNA": require("../../assets/images/pilka-nozna.png"),
  "TENIS ZIEMNY": require("../../assets/images/tenis-ziemny.png"),
  "TENIS STOŁOWY": require("../../assets/images/tenis-stolowy.png"),
